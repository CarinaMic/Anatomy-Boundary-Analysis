classdef Import
    % Import class to import stl-data of a pelvis
    ...
    properties 
        loaded = struct();      % Import: loaded data (stl)
        processed = struct();   % Import processed: new vertices and faces structure            
    end
    ...
    methods
        ...
        function obj = importData(obj,pelvisNum,filename)
            ...
            % Department of Orthopaedics and Sportorthopaedics, TUM School of Medicine and Health, Klinikum rechts der Isar, Technical University of Munich
            % Institute for Machine Tools and Industrial Management, TUM School of Engineering and Design, Technical University of Munichh
        ...
        function obj = importSTL(obj,pelvisNum,filename)
            ...
            % Mirroring at xy-plane -> z-Coordinate * (-1)
            if obj.loaded.pelvicSide=="right"
                obj.processed.vertices(:,3) = (-1) * obj.processed.vertices(:,3);
